...
| `npm run test:nexus-editor-content` | `tests/lib/nexusEditor/nexusEditorContent.test.ts` | `nexusEditorContent.ts`, `NexusRichTextEditor.tsx`, `NexusRichTextView.tsx` | Rich text HTML allowlist, mention anchor serialization, unsafe href stripping. |
