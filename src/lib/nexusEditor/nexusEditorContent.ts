 ...
 *
 * Extends the Puck body-text allowlist with inline mention anchors. Used by
 * {@link NexusRichTextEditor} and {@link NexusRichTextView}.
 *
 * Tests: `npm run test:nexus-editor-content` — see `tests/lib/nexusEditor/nexusEditorContent.test.ts`
 *
