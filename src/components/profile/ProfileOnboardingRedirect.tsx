...
import { enforceMemberTelegramCompliance, enforceProfileOnboarding, enforceTeacherAccessApproval } from "@/lib/profileOnboardingGate";
...
export async function ProfileOnboardingRedirect() {
  ...
  await enforceTeacherAccessApproval(session.user.id, pathname);
