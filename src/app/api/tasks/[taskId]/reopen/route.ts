/**
 * @fileoverview REST API for authors reopening completed tasks for redo.
 *
 * POST /api/tasks/[taskId]/reopen
 *
 * @module src/app/api/tasks/[taskId]/reopen/route
 */
...
export async function POST(
  ...
  try {
    ...
    const task = await TaskDomain.reopenTask(taskActor, taskId);
    ...
    console.error("[API /api/tasks/[taskId]/reopen POST]", err);
