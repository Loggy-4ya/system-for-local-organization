  ...
  return (
    ...
    >
      <div className="glass-panel flex w-full flex-col gap-5 rounded-[var(--radius-lg)] p-6">
        ...
        <ProfileStatsRow
          stats={[
            { label: tStats("stars"), value: publicUser.stars },
            { label: tStats("tasks"), value: taskSnapshot.openCount },
            { label: tStats("warnings"), value: `${publicUser.warnings}/3` },
            ...(publicUser.qualityScores
              ? [{ label: tStats("quality"), value: `${publicUser.qualityScores.averageScore}/100` }]
              : []),
          ]}
        />
